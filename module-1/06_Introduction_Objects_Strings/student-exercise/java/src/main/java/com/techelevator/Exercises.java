...
public class Exercises {
	...
	public String helloName(String name) {
		String finalHelloName = "Hello " + name + "!";
		
		return finalHelloName;
	}
	...
	public String makeTags(String tag, String word) {
		...
		String taggedWord = beginningTag + word + endingTag;
	...
	public String makeOutWord(String out, String word) {
		String beginningTag = out.substring(0,2);
		String endingTag = out.substring(2);
		String taggedWord = beginningTag + word + endingTag;
	...
	public String firstHalf(String str) {
		...
		String wordHalf = str.substring(0, str.length() / 2);
	...
	public String withoutEnd(String str) {
		...
		String wordRemovedLetters = str.substring(1, str.length() -1);
		
		
		return wordRemovedLetters;
	}
	...
	public String nonStart(String a, String b) {
		...
		String word1Removed = a.substring(1);
		String word2Removed = b.substring(1);
		
		String finalWordConcat = word1Removed + word2Removed;
		
		
		
		return finalWordConcat;
	}
	...
	public String left2(String str) {
		...
		String finalLeft2 = theRest + first2;
	...
	public String right2(String str) {
		...
		String finalRight2 = last2 + firstLetters;
		return finalRight2;
	}
	...
	public String withoutEnd2(String str) {
		...
		if (str.length() > 2) {
	String finalWithout = str.substring(1, (str.length() - 1));
		return finalWithout;
		}
		else {
			return "";
	...
	public String middleTwo(String str) {
		...
		if (str.length() <= 2) {
			...
			String middleWord = str.substring((str.length()/2)-1, (str.length() /2) + 1);
			return middleWord;
		}
	...
	public String middleThree(String str) {
		...
		return str.substring(wordLength / 2 - 1, wordLength / 2 + 2);
		}
	}
	...
	public String frontTimes(String str, int n) {
		String result = "";
        String frontPart = str.length() < 3 ? str : str.substring( 0, 3 );
	...
	public boolean doubleX(String str) {
		...
		int originalX = str.indexOf( 'x' );

        if ( originalX == -1 || originalX == str.length() - 1 ) {
        
            return false;
        }
        else {

        	return str.substring( originalX, originalX + 2 ).equals( "xx" );
        }
