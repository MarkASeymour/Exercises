...
SELECT customer.first_name, customer.last_name, SUM(payment.amount) dollars_spent
FROM customer
...
SELECT store.store_id, address.address, COUNT(rental.rental_id) total_rentals, SUM(payment.amount) total_sales, AVG(payment.amount) avg_sales_amnt
FROM store
