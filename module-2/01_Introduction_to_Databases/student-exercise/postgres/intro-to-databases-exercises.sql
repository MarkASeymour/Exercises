...
SELECT name, ( (gnp / population) * 1000000 ) AS percapitagnp FROM country WHERE continent = 'Europe';

-- 22. The number of years since independence for all countries that have a year of independence (192 rows)
SELECT name, ( 2020 - indepyear ) AS yearssinceindependence FROM country WHERE indepyear IS NOT NULL;
